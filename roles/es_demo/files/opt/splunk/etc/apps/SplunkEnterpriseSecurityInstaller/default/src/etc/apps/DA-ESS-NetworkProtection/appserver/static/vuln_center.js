...
require(['jquery','underscore','splunkjs/mvc', 'splunkjs/mvc/simplexml/ready!'],
    ...
    function make_bunit_token(value) {            
        ...
        if (value !== null && value !== '') {
            bunit = '(Vulnerabilities.dest_bunit="' + value + '" OR Vulnerabilities.user_bunit="' + value + '")';
        }
    ...
    function make_category_token(value) {            
        ...
        // update tokens if value is positive
        if (value !== null && value !== '') {
            category = '(Vulnerabilities.dest_category="' + value + '" OR Vulnerabilities.user_category="' + value + '")';
        }
